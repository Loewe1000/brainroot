...
/// brace and its gaps, `cloud` pads a cloud, `padding` frames a coloured
/// background. Lengths in `em` follow the font size around the map.
///
/// -> dictionary
#let spacing-defaults = (
  level: 3.5em, root: 6em, sibling: 0.7em, branch: 2em, max-width: 14em,
  brace: 0.6em, summary: 0.5em, cloud: 0.6em, padding: 1em,
)
